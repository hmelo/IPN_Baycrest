...
```{r predsouts, tidy=TRUE, tidy.opts=list(width.cutoff=55)}
  ...
  cg.unpaid <- c("askhelp","notime","feelstre","feelemba","feelangr","affects","afraid","dependen","strained","suffered","privacy","soclife","friends","expect","expenses","unable","lostctrl","leave","uncertai","doing","better","burdened","zarscore")
  ### caregiver "felt"
