...
```{r predsouts, tidy=TRUE, tidy.opts=list(width.cutoff=55)}
  ...
  predictors <- CSHA.1991.zarit_disorders[,c("CASEID",demographics,famhistory,cg.demographics,languages,health.drugs,substances,head.inj,cognition,beh.disturb,depress,dementia,alz,neuropsych)]  
