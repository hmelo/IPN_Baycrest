...
```{r preliminary_clean_up_predictors, echo=F, include=F}
...
```{r find_outliers_predictors, echo=F, include=F}
...
```{r preliminary_clean_up_outcomes, echo=F, include=F}
...
```{r fixed_analyses, echo=F, include=F}
...
```{r inference_supplemental, echo=F}
## skipping this.
  ## pure supplemental
#sup.cols <- supplementaryCols(final.outs,res = pred.ca)
